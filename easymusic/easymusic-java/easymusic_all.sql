...
--
-- Table structure for table `music_cover_creation`
--

DROP TABLE IF EXISTS `music_cover_creation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `music_cover_creation` (
...
--
-- Dumping data for table `music_cover_creation`
--

LOCK TABLES `music_cover_creation` WRITE;
/*!40000 ALTER TABLE `music_cover_creation` DISABLE KEYS */;
/*!40000 ALTER TABLE `music_cover_creation` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `music_info` (
  ...
  `music_type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '音乐类型 0:音乐 1:纯音乐',
  `publish_status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '发布状态 0:草稿 1:已发布 2:已隐藏',
  `publish_time` datetime DEFAULT NULL COMMENT '发布时间',
  `cover_source` tinyint(1) NOT NULL DEFAULT '0' COMMENT '封面来源 0:手动上传 1:AI生成',
  `cover_generate_count` int NOT NULL DEFAULT '0' COMMENT 'AI封面生成次数',
