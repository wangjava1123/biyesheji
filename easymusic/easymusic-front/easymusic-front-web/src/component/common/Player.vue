<template>
  ...
  <audio v-if="audioPath" ref="audioPlayerRef" class="audio" :volume="volume / 100"
    :src="audioSrc" @loadedmetadata="onLoadedMetadataHandler" @timeupdate="onTimeUpdateHandler"
...
const audioSrc = computed(() => {
  ...
  if (audioPath.value.startsWith('http')) return audioPath.value
  return proxy.Api.getResource + audioPath.value
})
watch(
